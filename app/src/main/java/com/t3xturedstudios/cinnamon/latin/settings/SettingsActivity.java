...
import com.t3xturedstudios.cinnamon.latin.utils.FragmentUtils;
...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void addFooterIfMissing() {
        if (getListView().getFooterViewsCount() == 0) {
            View footer = getLayoutInflater().inflate(R.layout.settings_footer, null);
