...
package com.t3xturedstudios.cinnamon.latin.inputlogic;
...
import com.t3xturedstudios.cinnamon.latin.RichInputConnection;
...
import com.t3xturedstudios.cinnamon.latin.utils.InputTypeUtils;
import com.t3xturedstudios.cinnamon.latin.utils.RecapitalizeStatus;
import com.t3xturedstudios.cinnamon.latin.utils.SubtypeLocaleUtils;
...
public final class InputLogic {
        ...
        switch (event.mCodePoint) {
            ...
            case Constants.CODE_ENTER:
                ...
                if (mLatinIME.isBrowserActive && mLatinIME.cinnamonController != null) {
                    mLatinIME.cinnamonController.sendEnterToWebView();
                    return;
                }
    ...
    private void handleBackspaceEvent(final Event event, final InputTransaction inputTransaction) {
        ...
        if (mLatinIME.isBrowserActive && mLatinIME.cinnamonController != null) {
            mLatinIME.cinnamonController.sendBackspaceToWebView();
            return;
        }
